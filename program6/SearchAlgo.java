...
int binarySimpleResult = binarySearchSimple(arr, target);

if (binarySimpleResult != -1)
    System.out.println("Element found at index: " + binarySimpleResult);
else
    System.out.println("Element not found");


System.out.println("\n---- Recursive Binary Search Result ----");
int binaryRecursiveResult = binarySearchRecursive(arr, 0, arr.length - 1, target);
